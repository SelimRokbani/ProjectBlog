...
* L'âge du tireur/marqueur de but. L'âge est une donnée potentiellement corrélée à l'expérience et la performance du joueur et de ce fait intéressante à étudier pour les tirs et les buts. ‘gameData.dateTime.dateTime’ et ‘birthdate’ dans ‘gameData.players’ permet de calculer l'âge de tireur/marqueur au moment du jeu.
* La précision de tir d’un joueur pour la saison pour savoir la performance du joueur: cette précision peut être déduite du nombre de buts du joueur sur son nombre total de tirs (tirs cadrés au filet, manqués, bloqués ou buts) pour la saison.
